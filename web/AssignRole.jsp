...
<html>
    ...
    <center>
        ...
        <form method = "POST"> 
            ...
            <br>
            <br>
            <input class="text" type="checkbox" name="ExamSetter" value=""> Exam Setter<br>
            <input class="text" type="checkbox" name="InternalModerator" value=""> Internal Moderator<br>
            <input class="text" type="checkbox" name="ExternalExaminer" value=""> External Examiner<br>
            <input class="text" type="checkbox" name="ExamVettingComittee" value=""> Exam Vetting Committee<br>
            <input class="text" type="checkbox" name="SchoolOffice" value=""> School Office<br>
            <input class="text" type="checkbox" name="LocalExamOfficer" value=""> Local Exam Officer<br>
            <br> 



            <button class="btn btn-lg btn-actuallyblue" type = "submit" name = "Assign">Assign Roles</button>
        </form> 
    </center>
        <%
