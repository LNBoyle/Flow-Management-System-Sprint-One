...
function displayalert(x) {
    ...
    document.getElementById('1').value = x.cells[0].innerHTML;
    document.getElementById('2').value = x.cells[1].innerHTML;
    document.getElementById('3').value = x.cells[2].innerHTML;
    document.getElementById('4').value = x.cells[3].innerHTML;
    document.getElementById('5').value = x.cells[4].innerHTML;
    document.getElementById('6').value = x.cells[5].innerHTML;
    document.getElementById('7').value = x.cells[6].innerHTML;
    document.getElementById('8').value = x.cells[7].innerHTML;
    document.getElementById("9").value = x.cells[8].innerHTML;
    document.getElementById("10").value = x.cells[9].innerHTML;
